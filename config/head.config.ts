...
const description =
	"Portfolio Website of Adilkhan Askarov. Frontend Developer. Creating responsive and cross-browser websites using Vue, React, Nuxt, Next.";
const link = "https://askarov.dev/";
const image = "/images/seo.jpg";

const headConfig: AppConfig["head"] = {
	htmlAttrs: { lang: "en" },
